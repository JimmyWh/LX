...
static struct fb_ops s3c_lcdfb_ops = {
	...
	.fb_fillrect	= s3c_lcdfb_fillrect,
	.fb_copyarea	= s3c_lcdfb_copyarea,
	.fb_imageblit	= s3c_lcdfb_imageblit,
	.fb_open        = mylcd_open,
...
#if 0 
	for (i=0;i < sizeof(lcd_regs_backup))
						...
						void *dummy)
{
	...
	case PM_SUSPEND_PREPARE:
		printf("lcd suspend notifiler test: PM_SUSPEND_PREPARE\n");
		return NOTIFY_OK;
	case PM_POST_SUSPEND:
		printf("lcd suspend notifiler test: PM_POST_SUSPEND\n");
		return NOTIFY_OK;
	default:
		return NOTIFY_DONE;
...
static sturct notifier_block lcd_pm_notif_block = {
...
static int lcd_init(void)
{
	...
	gpccon = ioremap(0x5600030,4);
	gpccon = ioremap(0x5600060,4);
	...
	*gpgcon |= (3 <<8);
	...
	lcd_regs->lcdcon2 = (1 << 24) | (271 << 14) | (1 <<16) | (9);
